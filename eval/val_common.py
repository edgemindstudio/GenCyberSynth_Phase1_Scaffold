...
def _build_eval_cnn(input_shape: Tuple[int, int, int], num_classes: int) -> tf.keras.Model:
    """Small, consistent evaluator CNN used across all models."""
    from tensorflow.keras import layers, models
    m = models.Sequential(name="EvalCNN")
    m.add(layers.Conv2D(32, 3, activation="relu", input_shape=input_shape))
